        ...
        {testimonials.map((item, index) => {
          ...
          return (
            <SwiperSlide
              ...
              className={`h-[440px] relative pt-6 transition-transform duration-300 ease-in-out ${
                isActive ? "z-[70]" : "z-[10]"
              }`}
            >
              <div className="relative h-[440px] md:h-[500px] lg:h-[600px] w-full rounded-t-xl overflow-hidden">
                <iframe
