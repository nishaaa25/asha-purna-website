    ...
    <div className="flex lg:gap-6 md:gap-4 gap-2 relative mb-10">
      {tabs.map((tab, index) => (
        <button
          ...
          } font-medium lg:font-bold text-sm md:text-2xl lg:text-lg py-[6px] md:py-[10px] lg:py-2 flex-1 w-full rounded-t-sm capitalize transition-all duration-300 cursor-pointer`}
        >
          {tab}
        </button>
      ))}
