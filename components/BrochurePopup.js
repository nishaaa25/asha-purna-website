...
export default function BrochurePopup({ 
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50" suppressHydrationWarning>
        ...
        <div className="w-full h-full flex flex-col items-center justify-center px-8">
          ...
          <form onSubmit={handleSubmit} className="w-full max-w-md space-y-12 flex-center flex-col mt-10">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="px-10 bg-black-400 text-white py-[14px] rounded-md text-xs font-medium hover:bg-gray-800 transition-colors duration-200 mt-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <>
